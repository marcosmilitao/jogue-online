...
import net.jogueonline.config.Constants;
import net.jogueonline.domain.Authority;
import net.jogueonline.domain.User;
import net.jogueonline.repository.AuthorityRepository;
import net.jogueonline.repository.UserRepository;
import net.jogueonline.security.AuthoritiesConstants;
import net.jogueonline.service.UserService;
import net.jogueonline.service.dto.PasswordChangeDTO;
import net.jogueonline.service.dto.UserDTO;
import net.jogueonline.web.rest.vm.KeyAndPasswordVM;
import net.jogueonline.web.rest.vm.ManagedUserVM;
...
import static net.jogueonline.web.rest.AccountResourceIT.TEST_USER_LOGIN;
