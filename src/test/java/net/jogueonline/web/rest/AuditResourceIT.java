...
import net.jogueonline.config.audit.AuditEventConverter;
import net.jogueonline.domain.PersistentAuditEvent;
import net.jogueonline.repository.PersistenceAuditEventRepository;
import net.jogueonline.security.AuthoritiesConstants;

import net.jogueonline.service.AuditEventService;
